...
var showtimes = function () {
  ...
  _createClass(showtimes, [{
    ...
    key: 'getTheater',
    value: function getTheater(theaterId, cb) {
      var api = this;
    ...
    key: 'getMovie',
    value: function getMovie(movieId, cb) {
      var api = this;
    ...
    key: '_parseTheater',
    value: function _parseTheater($, theater, alternate, theaterId) {
    ...
    key: '_parseMovie',
    value: function _parseMovie($, movie, alternate, movieId) {
    ...
    key: '_parseShowtimes',
    value: function _parseShowtimes($, thing) {
      var meridiem = false;
      var response = {};
      ...
      var getTime = function getTime(raw_time) {
    ...
    key: '_parseTrailer',
    value: function _parseTrailer(movie) {
    ...
    key: '_parseImdb',
    value: function _parseImdb(movie) {
    ...
    key: '_removeNonAsciiCharacters',
    value: function _removeNonAsciiCharacters(thing) {
    ...
    key: '_request',
    value: function _request(params, cb, handler) {
      var query = {
        hl: this.lang,
        near: this.location,
        date: this.date,
